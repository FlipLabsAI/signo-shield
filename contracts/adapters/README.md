...
| --- | --- | --- |
| `aave-v3/AaveV3Adapter.sol` | `supply`, `repay`, `repayWithCollateral` | Aave V3. Fork-tested against the X Layer market; the swap leg replays real DEX aggregator calldata (router `0x7c5BEE2A…aeAf`, approval contract `0x8b773D83…F000` on X Layer). |
