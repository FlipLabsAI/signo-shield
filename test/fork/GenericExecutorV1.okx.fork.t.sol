...
contract GenericExecutorV1OkxForkTest is Test {
    ...
    uint256 internal constant FORK_BLOCK = 70_752_723; // replaced by the fixture's block
    address internal constant FIXTURE_SANDBOX = address(0); // replaced by the fixture's wallet address
    uint256 internal constant AMOUNT_IN = 0.0079e18;
    bytes internal constant OKX_CALLDATA = hex"";
